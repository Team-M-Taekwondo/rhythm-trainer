...
(function () {
  ...
  MT.CAMP_BLOCKS = [
      ...
      note: "Loosening up, not correcting technique yet" },
    {
      ...
      runs: [
        { type: "drill", preset: "inplace", name: "Front Stance · Low Block", reps: 10, setsPerRound: 2, rounds: 1, rest: 10 },
        { type: "drill", preset: "inplace", name: "Front Stance · High Block", reps: 10, setsPerRound: 2, rounds: 1, rest: 10 },
        { type: "drill", preset: "inplace", name: "Back Stance · Single Knife Hand", reps: 10, setsPerRound: 2, rounds: 1, rest: 10 },
        { type: "drill", preset: "inplace", name: "Back Stance · Double Knife Hand", reps: 10, setsPerRound: 2, rounds: 1, rest: 10 },
